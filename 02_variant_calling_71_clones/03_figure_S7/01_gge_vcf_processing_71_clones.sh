...
#SBATCH -e shell_outputs/yerrors_%A_%a.err # File to which STDERR will be written
...
# See snpeff_database_create_71.sh for how I created the appropriate SnpEff database for w303_gge_corr_71

# Annotating variants with snpEff
snpEff w303_gge_corr_71 $CLONES_VCF > GGE_clones_corr_ann.vcf
...
# Do not -- Filter out variants with any clone's alt allele frequency < 0.75
# Filter out variants with low alt allele counts (in all clones they appear) & set alt counts <5 to 0
python filter_variants_no_alt75.py GGE_clones_corr_ann_split.tsv
