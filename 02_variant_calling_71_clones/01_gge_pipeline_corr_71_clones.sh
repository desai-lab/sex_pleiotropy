...
## How to run sbatch
## sbatch gge_pipeline_corr_71_clones.sh
## sbatch --dependency=afterok:56040843 gge_pipeline_corr_database_71_clones.sh #add the jobID for the gge_pipeline_corr_71_clones.sh sbatch e.g.56040843
...
bwa mem -M -t 1 -R "@RG\tID:HTLMC.1\tSM:${sample_base}\tPL:ILLUMINA" ../01_reference_correction_71_clones/w303_gge_corr_71 \
