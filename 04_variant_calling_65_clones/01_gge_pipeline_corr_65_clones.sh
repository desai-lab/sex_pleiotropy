...
#SBATCH --array=0-64                      # Job array range (based on sample count)
...
## How to run sbatch
## sbatch gge_pipeline_corr_65_clones.sh
## sbatch --dependency=afterok:56040843 gge_pipeline_corr_database_65_clones.sh #add the jobID for the gge_pipeline_corr_65_clones.sh sbatch e.g.56040843

# Define the path to the sample list
sample_list_file="../gge_clones_fastq_files_list_65_clones.txt"
...
reference="../03_reference_correction_65_clones/w303_gge_corr_65.fasta"
...
bwa mem -M -t 1 -R "@RG\tID:HTLMC.1\tSM:${sample_base}\tPL:ILLUMINA" ../03_reference_correction_65_clones/w303_gge_corr_65 \
