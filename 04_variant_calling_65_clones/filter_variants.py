...
def generate_low_coverage_blocks(coverage_file, coverage_threshold=650): #average 10x coverage for 65 clones
...
def main():
    ...
    # Coverage file
    coverage_file = "../03_reference_correction_65_clones/coverage.txt"
